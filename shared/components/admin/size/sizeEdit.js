...
class SizeEdit extends Component{
    ...
    componentDidMount(){
        const self = this
        ServiceSize.detail({id: this.props.params.id})
        .then((detail)=>{
                    ...
                    <Column>
                        <Segment>
                            ...
                            <Form type="div">
                                ...
                                <Button className="fluid" onClick={this._onEditSize.bind(this)} ref="buttonEdit">Sua</Button>
                            </Form>
                        </Segment>
                    </Column>
                </Row>
